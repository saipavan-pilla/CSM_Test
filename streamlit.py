...
# # HTML template to display the figures
# html_template = """
# <html>
# <head>
...
#     <img src="data:image/png;base64,{{fig1_data}}" alt="Emotion Distribution">
#     <h2>Salesperson Rating</h2>
#     <img src="data:image/png;base64,{{fig2_data}}" alt="Salesperson Rating">
# </body>
# </html>
# """

# # Insert the base64-encoded image data into the HTML template
# html_output = html_template.replace("{{fig1_data}}", fig1_data).replace("{{fig2_data}}", fig2_data)

# # Save the HTML output to a file
# with open("emotion_analysis_results.html", "w") as f:
#     f.write(html_output)
...
def load_emotion_model():
    with warnings.catch_warnings():
        warnings.simplefilter("ignore")
        return tf.keras.models.load_model('/workspace/CSM/models/emotion_model.h5')
...
async def upload_video(video_file: UploadFile = File(...)):
    ...
    #     # Return the figures and other desired values
    #     return fig1, fig2, total_emotion_count, max_emotion, max_count, rating_level, filtered_emotions


    # if __name__ == '__main__':
    #     fig1, fig2, total_emotion_count, max_emotion, max_count, rating_level, filtered_emotions = main()
